...
export default function ProfileCauseForm1({ profileData, handleGetProfile }){
  ...
  async function handleCauseCreate(){
    try {
      ...
      const formData = { cause3: causeId, id: profileData.id };
  ...
  async function handleCauseStop(){
    try {
      ...
      await causeService.remove(id);
      const formData = { cause3: 0, id: profileData.id };
      await userService.update(formData);
      handleGetProfile();
      setActive1(false);
      setActive2(false);
    ...
    <Container>
      ...
      <Form  autoComplete="off">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Start Cause 3</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form.Group>
      ...
      <Form  autoComplete="off">
        <Modal show={showUpdate} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Update Cause 3</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form.Group>
              <Form.Label>Name</Form.Label>
      ...
      <Form  autoComplete="off">
        <Modal show={showStop} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Stop Cause 3</Modal.Title>
          </Modal.Header>
          <Modal.Body>
