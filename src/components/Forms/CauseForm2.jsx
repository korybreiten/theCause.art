...
export default function CauseForm1({ profileData, handleGetProfile }){
  ...
  async function handleCauseCreate(){
    try {
      ...
      const formData = { cause2: causeId, id: profileData.id };
  ...
  async function handleCauseStop(){
    try {
      ...
      await causeService.remove(id);
      const formData = { cause2: 0, id: profileData.id };
      await userService.update(formData);
      handleGetProfile();
      setActive1(false);
      setActive2(false);
    ...
    <Container>
      ...
      <Form  autoComplete="off">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Start Cause 2</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form.Group>
      ...
      <Form  autoComplete="off">
        <Modal show={showUpdate} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Update Cause 2</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form.Group>
              <Form.Label>Name</Form.Label>
      ...
      <Form  autoComplete="off">
        <Modal show={showStop} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Stop Cause 2</Modal.Title>
          </Modal.Header>
          <Modal.Body>
