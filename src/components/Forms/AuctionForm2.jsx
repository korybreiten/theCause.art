...
export default function ProfileAuctionForm2({ profileData, handleGetProfile }){
  let id = profileData.auction2;
  ...
  async function handleAuctionCreate(){
    try {
      ...
      const formData = { auction2: auctionId, id: profileData.id };
  ...
  async function handleAuctionStop(){
    try {
      ...
      await auctionService.remove(id);
      const formData = { auction2: 0, id: profileData.id };
      await userService.update(formData);
      handleGetProfile();
      setActive1(false);
      setActive2(false);
    ...
    <Container>
      ...
      <Form  autoComplete="off">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Start Auction 2</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form.Group>
      ...
      <Form  autoComplete="off">
        <Modal show={showUpdate} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Update Auction 2</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form.Group>
              <Form.Label>Name</Form.Label>
      ...
      <Form  autoComplete="off">
        <Modal show={showStop} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Stop Auction 2</Modal.Title>
          </Modal.Header>
          <Modal.Body>
